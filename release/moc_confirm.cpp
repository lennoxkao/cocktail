...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_confirm_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_confirm_t qt_meta_stringdata_confirm = {
    {
QT_MOC_LITERAL(0, 0, 7), // "confirm"
QT_MOC_LITERAL(1, 8, 7), // "sentMsg"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 4), // "msgs"
QT_MOC_LITERAL(4, 22, 16), // "on_check_clicked"
QT_MOC_LITERAL(5, 39, 17) // "on_cancel_clicked"

    },
    "confirm\0sentMsg\0\0msgs\0on_check_clicked\0"
    "on_cancel_clicked"
};
...
void confirm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->sentMsg((*reinterpret_cast< const int(*)>(_a[1]))); break;
        case 1: _t->on_check_clicked(); break;
        ...
        {
            typedef void (confirm::*_t)(const int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&confirm::sentMsg)) {
                *result = 0;
            }
        }
    }
...
void *confirm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_confirm.stringdata))
...
// SIGNAL 0
void confirm::sentMsg(const int _t1)
{
